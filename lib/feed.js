...
exports.Author = class Author {
	...
	this.name = exports.html2text(name) || ''
	this.email_placeholder = 'rss@example.com'
	this.email = email || this.email_placeholder
    }
...
exports.metadata = function(meta) {
	...
	managingEditor: author([new exports.Author(get(meta["atom:author"], "name.#"), get(meta["atom:author"], "email.#")), new exports.Author(meta.author)]),
...
exports.article = function(item, count) {
	...
	author: author([new exports.Author(get(item["atom:author"], "name.#"), get(item["atom:author"], "email.#")),
			...
			item.meta.managingEditor, // FIXME
			new exports.Author(item.meta.title)]),
